...
- разнообразие: какие отряды и статусы МСОП попались; редкие виды (CR, EN) — отдельно, если они есть;
...
- Коды статусов МСОП можно расшифровать: LC — вызывающий наименьшие опасения, NT — близкий к уязвимому, VU — уязвимый, EN — вымирающий, CR — на грани исчезновения, DD — недостаточно данных.
